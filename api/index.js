...
var app=express(),pool=new pg.Pool({connectionString:(process.env.DATABASE_URL||'').replace(/:5432/,':6543'),ssl:{rejectUnauthorized:false},max:5,idleTimeoutMillis:5000});
